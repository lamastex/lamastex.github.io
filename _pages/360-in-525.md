...
This module will allow you to formalise notions like the *Where Am I?* Operator in a given *population ideological tree or forest* of *retweet networks* in order to better understand if you are possibly subject to [micro-propaganda machines](micro propaganda machine https://medium.com/@d1gi/the-election2016-micro-propaganda-machine-383449cc1fba) (as shown below) and other similar opinion engineering operations and try digesting [gdelt project](https://www.gdeltproject.org/) global news streams with embeddings and models. 
