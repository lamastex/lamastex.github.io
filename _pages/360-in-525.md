...
This module will introduce you to topic modeling and allow you to formalise notions like the *Where Am I?* Operator in a given *population ideological tree or forest* of *retweet networks* in order to investigate the influence of [micro propaganda machines](https://medium.com/@d1gi/the-election2016-micro-propaganda-machine-383449cc1fba) (as shown below) and other similar opinion engineering operations, if any. We may try digesting [gdelt project](https://www.gdeltproject.org/) of global news streams with embeddings and models. 
