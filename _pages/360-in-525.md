...
Swedish industries that want to optimise their operations based on data at their disposal especially in geospatial analytics, security, recommender systems, heath care, etc. 

We expect a dozen keen students on each workshop day, except the mathematical course, and may need at least 1000 sek for each of the two fikas on each day out of the 11 days in total (sponsorships can be as low as 1000 sek and in return we will spend 1-2 minutes per 1000 sek by trying to formally relate the appropriate parts of the lecture, at the right mathematical juncture, to problems in your industry with an emphasis on your industry's current human resource needs that could be communicated to the course coordinator). 
