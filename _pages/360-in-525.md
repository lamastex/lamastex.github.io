...
This is a two-full-days workshop (2 hp) on **May 3-4 2018**. Prerequisites: 360-in-525-1  or 'Introduction to data Science'. The first day will be done by domain experts from Uppsala University's [Cultural Geographic Department](http://www.kultgeog.uu.se/) in order to introduce to the basic questions and datasets of the field, hands-on lab tutorials in non-distributed geospatial analytics. 
